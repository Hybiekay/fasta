...
import 'package:ziklogistics/views/chat/chatScreen.dart';
...
final Map<String, WidgetBuilder> routes = {
  ...
  MeunScreen.routeName: (context) => const MeunScreen(),
  ComleteTaskDetail.routeName: (context) => const ComleteTaskDetail(),
  ...
  DispatcherMeunScreen.routeName: (context) => const DispatcherMeunScreen(),
